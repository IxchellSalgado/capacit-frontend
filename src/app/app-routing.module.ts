...
import { ListarOrderItemsComponent } from './components/order-items/listar-order-items/listar-order-items.component' //Importamos OrderItem
...
const routes: Routes = [
  ...
  {path : 'OrderItems', component : ListarOrderItemsComponent}, //Agregamos la Ruta de Order Items
  {path : 'detalle-OrderItems/:id', component : DetalleOrderItemsComponent},
  {path : 'actualizar-OrderItems/:id', component : ActualizarOrderItemsComponent},
  {path : 'registrar-OrderItems', component: RegistrarOrderItemsComponent}
];
